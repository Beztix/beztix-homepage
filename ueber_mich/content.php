            ...
            <section class="text">
				...
				<table class="personal_data">
					<tr>
						...
						<td class="right">Sebastian Lützow</td>
					</tr>
					<tr>
						<td class="left">Spitzname:</td>
						<td class="right">Basti</td>
					</tr>
					<tr>
						<td class="left">Nickname:</td>
						<td class="right">Beztix</td>
					</tr>
					<tr>
						<td class="left">Geburtstag:</td>
						<td class="right">25.06.1991</td>
					</tr>
					<tr>
						<td class="left">Studium:</td>
						<td class="right">Informatik B.Sc.</td>
					</tr>
					<tr>
						<td class="left">Wohnort</td>
						<td class="right">Bayreuth</td>
					</tr>
				</table>
